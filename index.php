...
<body style="background-color: black;">
    <h1>Activity #5</h1>
    <a> </a>
    <a>Mark John B. Matinig & Jabiel Angelo C. Madrono | BSI/T-2A</a>
...
<div class="music-box">
    ...
    <script>
        function toggleAudio() {
            ...
            if (audio.paused) {
                audio.play();
                playPauseBtn.className = "fa fa-pause"; // Change icon to pause
            } else {
                audio.pause();
                playPauseBtn.className = "fa fa-play"; // Change icon to play
            }
        }
    </script>
</body>
